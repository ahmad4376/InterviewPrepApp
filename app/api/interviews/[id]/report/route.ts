...
export async function GET(_request: Request, { params }: { params: Promise<{ id: string }> }) {
  ...
  feedback.categories.forEach((cat) => {
    ...
    doc.rect(50, catY, 500, catFeedbackHeight).fill("#f8fafc");
    doc.rect(50, catY, 500, catFeedbackHeight).stroke("#e2e8f0");
  ...
  if (feedback.questionFeedback && feedback.questionFeedback.length > 0) {
    ...
    feedback.questionFeedback.forEach((qf, index) => {
      ...
      doc.rect(50, assessmentBoxY, 500, assessmentHeight).fill("#f0fdf4");
      doc.rect(50, assessmentBoxY, 500, assessmentHeight).stroke("#bbf7d0");
